<header class="flex justify-end my-2">
    <ul class="flex justify-center">
        ...
        <li class="mx-2">
            <a class="font-semibold hover:text-teal-400 flex gap-1" href="{{ route('cart') }}">
            Cart
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
...
<nav class="flex justify-between p-5 bg-gray-900">
    <div>
        <a href="/">
            <img src="{{ asset('logo/daphone-1.png') }}" class="max-w-20 absolute top-[30px]" alt="">
        </a> 
    </div>
