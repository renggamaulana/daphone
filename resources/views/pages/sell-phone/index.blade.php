...
@section('title', 'Jual HP') 

@section('content')
    <section class="p-10">
        <h1 class="text-4xl font-semibold font-serif">Jual HP lama kamu!</h1>
        <div class="border p-10 mt-5 bg-white">

            {{-- Form --}}
            <form action="{{ route('sell-phone.confirm') }}" method="get" class="mt-4 flex flex-col gap-5">
                @csrf
